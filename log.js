...
"main;1;<Launch(3, 1)>\n" +
"main;3;<Launch(3, 2)>\n" +
"1;1;<Put(1, 1, true, 1, 6)>\n" +
"3;3;<Put(1, 2, true, 1, 6)>\n" +
"1;2;<WriteAckReq(1, 1, 1)>\n" +
"3;1;<WriteAckReq(1, 2, 1)>\n" +
"3;2;<WriteAckReq(1, 2, 1)>\n" +
"3;3;<WriteAckReq(1, 2, 1)>\n" +
"1;1;<WriteAckReq(1, 1, 1)>\n" +
"1;3;<WriteAckReq(1, 1, 1)>\n" +
"1;1;<WriteAck(1, 1, 0, 1)>\n" +
"1;3;<WriteAck(1, 2, 0, 1)>\n" +
"3;1;<WriteAck(1, 1, 0, 1)>\n" +
"3;3;<WriteAck(1, 2, 0, 1)>\n" +
"3;3;<Write(1, 2, 1)>\n" +
"1;2;<Write(1, 1, 1)>\n" +
"3;1;<Write(1, 2, 1)>\n" +
"3;2;<Write(1, 2, 1)>\n" +
...
"1;1;<WriteAck(1, 13, 2, 5)>\n" +
"3;1;<WriteAck(1, 13, 2, 5)>\n" +
"1;3;<WriteAck(1, 13, 2, 5)>\n" +
"3;3;<WriteAck(1, 13, 2, 5)>\n" +
"1;2;<Write(1, 13, 3)>\n" +
"1;1;<Write(1, 13, 3)>\n" +
"3;2;<Write(1, 13, 3)>\n" +
"1;3;<Write(1, 13, 3)>\n" +
...
"3;1;<ReadAckReq(1, 6)>\n" +
"3;3;<ReadAckReq(1, 6)>\n" +
"1;1;<ReadAck(1, 13, 3, 6)>\n" +
"1;3;<ReadAck(1, 13, 3, 6)>\n" +
"3;1;<ReadAck(1, 13, 3, 6)>\n" +
"3;3;<ReadAck(1, 13, 3, 6)>\n" +
"1;2;<Write(1, 13, 3)>\n" +
"3;3;<Write(1, 13, 3)>\n" +
"3;2;<Write(1, 13, 3)>\n" +
"3;3;<WriteFinished()>\n" +
